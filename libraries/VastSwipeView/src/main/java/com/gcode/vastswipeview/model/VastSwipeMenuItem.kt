package com.gcode.vastswipeview.model
...
class VastSwipeMenuItem @JvmOverloads constructor(
    ...
    background: Drawable? = ContextCompat.getDrawable(context, R.drawable.bk_default_menu_item),
     ...
     * [com.gcode.vastswipeview.VastSwipeViewMgr.setIconSizeByDp]
     */
