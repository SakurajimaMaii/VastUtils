...
open class VastSwipeMenuLayout @JvmOverloads constructor(
    ...
    constructor(swipeMenuMgr: VastSwipeViewMgr, items:ArrayList<VastSwipeMenuItem>) : this(swipeMenuMgr.context,null,0) {
    ...
    /**
     * See the definition of the [VastSwipeViewMgr].
     */
    private lateinit var swipeMenuMgr: VastSwipeViewMgr
...
class VastSwipeLeftMenu: VastSwipeMenuLayout{
    ...
    constructor(vastSwipeMenuMgr: VastSwipeViewMgr):super(vastSwipeMenuMgr,vastSwipeMenuMgr.leftMenuItems)
}

class VastSwipeRightMenu: VastSwipeMenuLayout{
    @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr:Int = 0):super(context, attrs, defStyleAttr)

    constructor(vastSwipeMenuMgr: VastSwipeViewMgr):super(vastSwipeMenuMgr,vastSwipeMenuMgr.rightMenuItems)
}